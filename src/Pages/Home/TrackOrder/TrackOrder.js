...
const TrackOrder = () => {
    return (
        <div className='lg:flex justify-between items-center w-full mt-20'>
            <div className='w-full lg:w-1/2 px-10 md:px-10 lg:px-20'>
            ...
            <div className='w-full lg:w-1/2 mt-5 md:mt-10 lg:mt-0'>
                <img src={image} alt="" />
            </div>
        </div>
    );
