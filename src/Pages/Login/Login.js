...
import loginImage from '../../assets/login_register_images/login.jpg';
...
const Login = () => {
    ...
    return (
        <section className='my-28 block lg:flex justify-around'>
            ...
            <div className='w-[385px] h-[480px] shadow-xl  border px-[29px] py-[25px] mx-auto'>
                ...
                <form onSubmit={handleSubmit(handleLogin)}>
                    ...
                    <button className=' bg-black text-white px-2 md:px-3 lg:px-4 py-1 md:py-2 rounded-xl font-semibold w-full'>LogIn</button>
                    <div>
                        {
