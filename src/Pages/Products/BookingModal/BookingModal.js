...
const BookingModal = ({ bookingProduct, setBookingProduct }) => {
    ...
    let { name, image, resale_price } = bookingProduct;
    const { user } = useContext(AuthContext);
    console.log(resale_price);
    const setResalePrice = () => {
        resale_price = '';
        console.log(resale_price)
    }
    console.log(resale_price);
        ...
        <div>
            ...
            <div className="modal">
                <div className="modal-box relative text-black">
                    <label onClick={() => setBookingProduct(null)} htmlFor="booking-modal" className="btn btn-sm btn-circle absolute right-2 top-2">✕</label>
